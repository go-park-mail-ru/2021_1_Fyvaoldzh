...
var file_chat_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x32, 0xc1, 0x02, 0x0a, 0x04, 0x43, 0x68,
	...
	0x1a, 0x07, 0x2e, 0x41, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x22, 0x00, 0x12, 0x20, 0x0a, 0x06, 0x53,
	0x65, 0x61, 0x72, 0x63, 0x68, 0x12, 0x09, 0x2e, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x49, 0x6e,
	0x1a, 0x09, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x22, 0x00, 0x42, 0x0a, 0x5a,
...
var file_chat_proto_depIdxs = []int32{
	...
	11, // 22: Chat.Search:output_type -> Messages
...
type ChatClient interface {
	...
	Search(ctx context.Context, in *SearchIn, opts ...grpc.CallOption) (*Messages, error)
}
...
func (c *chatClient) Search(ctx context.Context, in *SearchIn, opts ...grpc.CallOption) (*Messages, error) {
	out := new(Messages)
...
type ChatServer interface {
	...
	Search(context.Context, *SearchIn) (*Messages, error)
}
...
func (*UnimplementedChatServer) Search(context.Context, *SearchIn) (*Messages, error) {
