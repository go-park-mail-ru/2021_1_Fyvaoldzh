...
func (m *MockIChatClient) DeleteDialogue(uid, id uint64) error {
	m.ctrl.T.Helper()
...
func (m *MockIChatClient) DeleteMessage(uid, id uint64) error {
	m.ctrl.T.Helper()
...
func (m *MockIChatClient) EditMessage(uid uint64, newMessage *models.RedactMessage) error {
	m.ctrl.T.Helper()
...
func (m *MockIChatClient) GetAllDialogues(uid uint64, page int) (models.DialogueCards, error) {
	m.ctrl.T.Helper()
...
func (m *MockIChatClient) GetOneDialogue(uid1, uid2 uint64, page int) (models.Dialogue, error) {
	m.ctrl.T.Helper()
...
func (m *MockIChatClient) Mailing(uid uint64, mailing *models.Mailing) error {
	m.ctrl.T.Helper()
...
func (m *MockIChatClient) Search(uid uint64, id int, str string, page int) (models.Messages, error) {
	m.ctrl.T.Helper()
...
func (m *MockIChatClient) SendMessage(newMessage *models.NewMessage, uid uint64) error {
	m.ctrl.T.Helper()
