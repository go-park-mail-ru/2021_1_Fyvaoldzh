...
func easyjsonD2b7633eDecodeKudagoApplicationModels38(in *jlexer.Lexer, out *ActionCard) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonD2b7633eEncodeKudagoApplicationModels38(out *jwriter.Writer, in ActionCard) {
	out.RawByte('{')
	first := true
	_ = first
	{
